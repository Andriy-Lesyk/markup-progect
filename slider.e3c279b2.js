...
function check() {
  if (window.matchMedia("(min-width: 320px)").matches && window.matchMedia("(max-width: 767px)").matches) {
    ...
    if (document.querySelector("#slick-slide-control00").closest("li").classList.contains("slick-active")) {
      list.style.transform = "translateX(192px)";
    }

    if (document.querySelector("#slick-slide-control01").closest("li").classList.contains("slick-active")) {
      list.style.transform = "translateX(128px)";
    }

    if (document.querySelector("#slick-slide-control02").closest("li").classList.contains("slick-active")) {
      list.style.transform = "translateX(64px)";
    }

    if (document.querySelector("#slick-slide-control03").closest("li").classList.contains("slick-active")) {
      list.style.transform = "translateX(0px)";
    }

    if (document.querySelector("#slick-slide-control04").closest("li").classList.contains("slick-active")) {
      list.style.transform = "translateX(-64px)";
    }

    if (document.querySelector("#slick-slide-control05").closest("li").classList.contains("slick-active")) {
      list.style.transform = "translateX(-128px)";
    }

    if (document.querySelector("#slick-slide-control06").closest("li").classList.contains("slick-active")) {
      list.style.transform = "translateX(-192px)";
    }
  }
}
...
setTimeout(function () {
  for (var i = 0; i < 7; i++) {
    document.querySelector("#slick-slide-control0".concat(i)).addEventListener("click", check);
  }
